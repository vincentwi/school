...
&= \frac{1 - \theta (4 + 4 \theta + n - n \theta)}{(n + 2)^2} \\
...
$$
\begin{aligned}
\text{log-likelihood} &= log(\frac{1}{\sqrt{2 \pi}} e^{-\frac{1}{2} \sum_{i=1}^n (x_i - \theta)^2}) \\
&= log(1) - log(\sqrt{2 \pi}) - \frac{\sum_{i=1}^n (x_i - \theta)^2}{2} \\
\end{aligned}
$$
